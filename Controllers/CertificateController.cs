...
public class CertificateController : ControllerBase
{
    ...
    public CertificateController(ICertificateService service) => _service = service;

    [HttpPost("gerar")]
    [Authorize(Roles = "Administrador,Gestor")]
    public async Task<ActionResult<CertificateDTO>> Gerar([FromBody] CreateCertificateDTO dto)
    {
    ...
    [Authorize]
    public async Task<ActionResult<IEnumerable<CertificateDTO>>> GetPorUsuario(int IdUsuario)
    {
